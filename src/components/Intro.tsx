...
function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-bold">Hello, I&apos;m Sheikh Ubaid Ullah.</span>{" "}
        I&apos;m a <span className="font-bold">frontend developer</span> with a
        strong focus on <span className="underline">React JS</span> and{" "}
        <span className="font-bold">Next JS</span>. I build{" "}
        <span className="italic">dynamic, responsive web applications</span>{" "}
